...
extern void bls12_381_G1_jac_batch_from_affine( int N, const uint64_t *src , uint64_t *tgt );
extern void bls12_381_G1_jac_batch_to_affine  ( int N, const uint64_t *src , uint64_t *tgt );
...
extern void bls12_381_G1_jac_MSM_binary_coeff_jac_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bls12_381_G1_jac_MSM_binary_coeff_affine_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bls12_381_G1_jac_multi_MSM_binary_coeff_jac_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
extern void bls12_381_G1_jac_multi_MSM_binary_coeff_affine_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
