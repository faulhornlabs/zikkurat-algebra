...
extern void bls12_381_G1_affine_convert_infinity_inplace( uint64_t *tgt );
extern void bls12_381_G1_affine_batch_convert_infinity_inplace( int N, uint64_t *tgt );
