...
extern void bls12_381_G1_proj_batch_from_affine( int N, const uint64_t *src , uint64_t *tgt );
extern void bls12_381_G1_proj_batch_to_affine  ( int N, const uint64_t *src , uint64_t *tgt );
...
extern void bls12_381_G1_proj_scl_Fr_std ( const uint64_t *kst , const uint64_t *src , uint64_t *tgt );
extern void bls12_381_G1_proj_scl_Fr_mont( const uint64_t *kst , const uint64_t *src , uint64_t *tgt );
...
extern void bls12_381_G1_proj_MSM_std_coeff_proj_out(int npoints, const uint64_t *expos, const uint64_t *grps, uint64_t *tgt, int expo_nlimbs);
extern void bls12_381_G1_proj_MSM_mont_coeff_proj_out(int npoints, const uint64_t *expos, const uint64_t *grps, uint64_t *tgt, int expo_nlimbs);
extern void bls12_381_G1_proj_MSM_binary_coeff_proj_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bls12_381_G1_proj_MSM_binary_coeff_affine_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bls12_381_G1_proj_multi_MSM_binary_coeff_proj_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
extern void bls12_381_G1_proj_multi_MSM_binary_coeff_affine_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
