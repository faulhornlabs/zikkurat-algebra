...
extern void bn128_G1_proj_normalize         ( const uint64_t *src , uint64_t *tgt );
extern void bn128_G1_proj_normalize_inplace (       uint64_t *tgt );
...
extern void    bn128_G1_proj_set_infinity  (       uint64_t *tgt );
extern uint8_t bn128_G1_proj_is_in_subgroup( const uint64_t *src );

extern uint8_t bn128_G1_proj_is_equal( const uint64_t *src1, const uint64_t *src2 );
extern uint8_t bn128_G1_proj_is_same ( const uint64_t *src1, const uint64_t *src2 );

extern void bn128_G1_proj_neg        ( const uint64_t *src ,       uint64_t *tgt );
extern void bn128_G1_proj_dbl        ( const uint64_t *src ,       uint64_t *tgt );
extern void bn128_G1_proj_add        ( const uint64_t *src1, const uint64_t *src2, uint64_t *tgt );
extern void bn128_G1_proj_sub        ( const uint64_t *src1, const uint64_t *src2, uint64_t *tgt );

extern void bn128_G1_proj_neg_inplace(       uint64_t *tgt );
extern void bn128_G1_proj_dbl_inplace(       uint64_t *tgt );
extern void bn128_G1_proj_add_inplace(       uint64_t *tgt , const uint64_t *src2 );
extern void bn128_G1_proj_sub_inplace(       uint64_t *tgt , const uint64_t *src2 );

extern void bn128_G1_proj_madd_proj_aff ( const uint64_t *src1, const uint64_t *src2, uint64_t *tgt );
extern void bn128_G1_proj_madd_aff_proj ( const uint64_t *src1, const uint64_t *src2, uint64_t *tgt );
...
extern void bn128_G1_proj_MSM_binary_coeff_proj_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bn128_G1_proj_MSM_binary_coeff_affine_out(int npoints, const uint8_t  *expos, const uint64_t *grps, uint64_t *tgt);
...
extern void bn128_G1_proj_multi_MSM_binary_coeff_proj_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
extern void bn128_G1_proj_multi_MSM_binary_coeff_affine_out(int nrows, int npoints, const uint8_t **expos, const uint64_t *grps, uint64_t *tgt);
extern void bn128_G1_proj_fft_forward( int m, const uint64_t *gen, const uint64_t *src, uint64_t *tgt );
extern void bn128_G1_proj_fft_inverse( int m, const uint64_t *gen, const uint64_t *src, uint64_t *tgt );
