...
extern void bls12_381_arr_mont_concat( int K , int *ns, const uint64_t **srcs, uint64_t *tgt );
...
extern void bls12_381_arr_mont_mul_by_powers ( int n, const uint64_t *coeffA , const uint64_t *coeffB, const uint64_t *src, uint64_t *tgt );
