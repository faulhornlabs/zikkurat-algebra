...
extern uint8_t bn128_p_std_is_zero   ( const uint64_t *src );
extern uint8_t bn128_p_std_is_one    ( const uint64_t *src );
extern uint8_t bn128_p_std_is_equal  ( const uint64_t *src1, const uint64_t *src2 );
extern void    bn128_p_std_set_zero  (       uint64_t *tgt );
extern void    bn128_p_std_set_one   (       uint64_t *tgt );
extern void    bn128_p_std_copy      ( const uint64_t *src , uint64_t *tgt );
...
extern void bn128_p_std_batch_inv        ( int n, const uint64_t *src, uint64_t *tgt );
