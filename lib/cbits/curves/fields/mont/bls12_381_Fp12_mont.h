...
extern void bls12_381_Fp12_mont_from_prime_field( const uint64_t *src , uint64_t *tgt );

extern void bls12_381_Fp12_mont_scale_by_base_field ( const uint64_t *coeff , const uint64_t *src, uint64_t *tgt );
extern void bls12_381_Fp12_mont_scale_by_prime_field( const uint64_t *coeff , const uint64_t *src, uint64_t *tgt );

extern void bls12_381_Fp12_mont_frobenius( const uint64_t *src , uint64_t *tgt );
extern void bls12_381_Fp12_mont_frobenius_inplace( uint64_t *tgt );
...
extern void bls12_381_Fp12_mont_div_by_2         ( const uint64_t *src1 , uint64_t *tgt );
extern void bls12_381_Fp12_mont_div_by_2_inplace ( uint64_t *tgt );
