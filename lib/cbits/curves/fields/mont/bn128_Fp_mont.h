...
extern void bn128_Fp_mont_batch_from_std ( int N, const uint64_t *src ,       uint64_t *tgt );
extern void bn128_Fp_mont_batch_to_std   ( int N, const uint64_t *src ,       uint64_t *tgt );
