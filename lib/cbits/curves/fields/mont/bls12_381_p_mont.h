...
extern uint8_t bls12_381_p_mont_is_zero  ( const uint64_t *src );
extern uint8_t bls12_381_p_mont_is_one   ( const uint64_t *src );
extern uint8_t bls12_381_p_mont_is_equal ( const uint64_t *src1, const uint64_t *src2 );
extern void    bls12_381_p_mont_set_zero (       uint64_t *tgt );
extern void    bls12_381_p_mont_set_one  (       uint64_t *tgt );
extern void    bls12_381_p_mont_copy     ( const uint64_t *src , uint64_t *tgt );
