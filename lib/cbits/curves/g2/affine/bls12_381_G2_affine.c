...
void bls12_381_G2_affine_set_ffff( uint64_t *tgt ) {
  memset( tgt, 0xff, 96 );
}

uint8_t bls12_381_G2_affine_is_ffff( const uint64_t *src ) {
  return ( (src[0] + 1 == 0) && (src[1] + 1 == 0) && (src[2] + 1 == 0) && (src[3] + 1 == 0) && (src[4] + 1 == 0) && (src[5] + 1 == 0) && (src[6] + 1 == 0) && (src[7] + 1 == 0) && (src[8] + 1 == 0) && (src[9] + 1 == 0) && (src[10] + 1 == 0) && (src[11] + 1 == 0) );
}
...
uint8_t bls12_381_G2_affine_is_infinity ( const uint64_t *src1 ) {
  return ( bls12_381_G2_affine_is_ffff( X1 ) &&
           bls12_381_G2_affine_is_ffff( Y1 ) );
}
...
void bls12_381_G2_affine_convert_infinity_inplace( uint64_t *tgt) 
{ if ( (bls12_381_Fp2_mont_is_zero(tgt           ) ) && 
       (bls12_381_Fp2_mont_is_zero(tgt + NLIMBS_P) ) ) {
    bls12_381_G2_affine_set_infinity(tgt);
  }
}

void bls12_381_G2_affine_batch_convert_infinity_inplace( int n, uint64_t *tgt ) 
{ uint64_t *q = tgt;
  for(int i=0; i<n; i++) {
    if ( (bls12_381_Fp2_mont_is_zero(q           ) ) && 
         (bls12_381_Fp2_mont_is_zero(q + NLIMBS_P) ) ) {
      bls12_381_G2_affine_set_infinity(q);
    }
    q += 2*NLIMBS_P;
  }
}
...
void bls12_381_G2_affine_set_infinity ( uint64_t *tgt ) {
  bls12_381_G2_affine_set_ffff( X3 );
  bls12_381_G2_affine_set_ffff( Y3 );
}
