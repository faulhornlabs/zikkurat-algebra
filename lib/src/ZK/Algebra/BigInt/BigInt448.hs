...
instance M.Rnd BigInt448 where
  rndIO = rnd

instance C.Ring BigInt448 where
  ringName _ = "BigInt448"
  ringSize _ = 726838724295606890549323807888004534353641360687318060281490199180639288113397923326191050713763565560762521606266177933534601628614656
