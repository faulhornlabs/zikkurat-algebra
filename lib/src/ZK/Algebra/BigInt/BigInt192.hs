...
module ZK.Algebra.BigInt.BigInt192 where
...
foreign import ccall unsafe "bigint192_sqr_truncated" c_bigint192_sqr_truncated :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()

{-# NOINLINE sqr #-}
sqr :: BigInt192 -> BigInt192 -> BigInt192
sqr (MkBigInt192 fptr1) (MkBigInt192 fptr2) = unsafePerformIO $ do
  fptr3 <- mallocForeignPtrArray 3
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bigint192_sqr_truncated ptr1 ptr2 ptr3
  return (MkBigInt192 fptr3)
