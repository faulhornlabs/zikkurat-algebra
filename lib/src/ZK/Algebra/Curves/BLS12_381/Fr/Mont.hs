...
instance C.Ring Fr where
  ringName _ = "BLS12-381/Fr (Montgomery repr.)"
  ringSize _ = prime
  isZero = ZK.Algebra.Curves.BLS12_381.Fr.Mont.isZero
  isOne  = ZK.Algebra.Curves.BLS12_381.Fr.Mont.isOne
  zero   = ZK.Algebra.Curves.BLS12_381.Fr.Mont.zero
  one    = ZK.Algebra.Curves.BLS12_381.Fr.Mont.one
  square = ZK.Algebra.Curves.BLS12_381.Fr.Mont.sqr
  power  = ZK.Algebra.Curves.BLS12_381.Fr.Mont.pow
...
instance FFTField Fr where
  theFFTDomain = ZK.Algebra.Curves.BLS12_381.Fr.Mont.fftDomain

----------------------------------------

foreign import ccall unsafe "bls12_381_Fr_mont_from_std" c_bls12_381_Fr_mont_from_std :: Ptr Word64 -> Ptr Word64 -> IO ()
...
fromStd (Std.MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_from_std ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_mont_to_std" c_bls12_381_Fr_mont_to_std :: Ptr Word64 -> Ptr Word64 -> IO ()
...
foreign import ccall unsafe "bls12_381_Fr_mont_pow_gen" c_bls12_381_Fr_mont_pow_gen :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> CInt -> IO ()
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withInteger expo $ \(nwords,ptr2) -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_pow_gen ptr1 ptr2 ptr3 (fromIntegral nwords)
  return (MkFr fptr3)
...
powBigInt256 (MkFr fptr1) (MkBigInt256 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_pow_gen ptr1 ptr2 ptr3 4
  return (MkFr fptr3)

----------------------------------------

foreign import ccall unsafe "bls12_381_Fr_mont_batch_inv" c_bls12_381_Fr_mont_batch_inv :: CInt -> Ptr Word64 -> Ptr Word64 -> IO ()
...
batchInv (MkFlatArray n fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_batch_inv (fromIntegral n) ptr1 ptr2
  return (MkFlatArray n fptr2)
...
foreign import ccall unsafe "bls12_381_Fr_std_is_valid" c_bls12_381_Fr_std_is_valid :: Ptr Word64 -> IO Word8

{-# NOINLINE isValid #-}
isValid :: Fr -> Bool
isValid (MkFr fptr) = unsafePerformIO $ do
  cret <- withForeignPtr fptr $ \ptr -> do
    c_bls12_381_Fr_std_is_valid ptr
  return (cret /= 0)

foreign import ccall unsafe "bls12_381_Fr_mont_is_zero" c_bls12_381_Fr_mont_is_zero :: Ptr Word64 -> IO Word8

{-# NOINLINE isZero #-}
isZero :: Fr -> Bool
isZero (MkFr fptr) = unsafePerformIO $ do
  cret <- withForeignPtr fptr $ \ptr -> do
    c_bls12_381_Fr_mont_is_zero ptr
  return (cret /= 0)

foreign import ccall unsafe "bls12_381_Fr_mont_is_one" c_bls12_381_Fr_mont_is_one :: Ptr Word64 -> IO Word8

{-# NOINLINE isOne #-}
isOne :: Fr -> Bool
isOne (MkFr fptr) = unsafePerformIO $ do
  cret <- withForeignPtr fptr $ \ptr -> do
    c_bls12_381_Fr_mont_is_one ptr
  return (cret /= 0)

foreign import ccall unsafe "bls12_381_Fr_mont_is_equal" c_bls12_381_Fr_mont_is_equal :: Ptr Word64 -> Ptr Word64 -> IO Word8
...
isEqual (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  cret <- withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_is_equal ptr1 ptr2
  return (cret /= 0)

foreign import ccall unsafe "bls12_381_Fr_mont_neg" c_bls12_381_Fr_mont_neg :: Ptr Word64 -> Ptr Word64 -> IO ()
...
neg (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_neg ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_mont_add" c_bls12_381_Fr_mont_add :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
add (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_add ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_mont_sub" c_bls12_381_Fr_mont_sub :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sub (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_sub ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_mont_sqr" c_bls12_381_Fr_mont_sqr :: Ptr Word64 -> Ptr Word64 -> IO ()
...
sqr (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_sqr ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_mont_mul" c_bls12_381_Fr_mont_mul :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
mul (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_mul ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_mont_inv" c_bls12_381_Fr_mont_inv :: Ptr Word64 -> Ptr Word64 -> IO ()
...
inv (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_inv ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_mont_div" c_bls12_381_Fr_mont_div :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
div (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_mont_div ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_mont_div_by_2" c_bls12_381_Fr_mont_div_by_2 :: Ptr Word64 -> Ptr Word64 -> IO ()
...
divBy2 (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_div_by_2 ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_mont_pow_uint64" c_bls12_381_Fr_mont_pow_uint64 :: Ptr Word64 -> Word64 -> Ptr Word64 -> IO ()
...
pow_ (MkFr fptr1) x = unsafePerformIO $ do
  ...
  cret <- withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_mont_pow_uint64 ptr1 x ptr2
  return (MkFr fptr2)
