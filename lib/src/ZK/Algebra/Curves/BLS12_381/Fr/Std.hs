...
module ZK.Algebra.Curves.BLS12_381.Fr.Std
  ( Fr(..)
  , prime
    -- * Conversion
  , to
...
instance C.Ring Fr where
  ringNamePxy _ = "BLS12-381/Fr (standard repr.)"
  ringSizePxy _ = prime
  isZero = ZK.Algebra.Curves.BLS12_381.Fr.Std.isZero
  isOne  = ZK.Algebra.Curves.BLS12_381.Fr.Std.isOne
  zero   = ZK.Algebra.Curves.BLS12_381.Fr.Std.zero
  one    = ZK.Algebra.Curves.BLS12_381.Fr.Std.one
  square = ZK.Algebra.Curves.BLS12_381.Fr.Std.sqr
  power  = ZK.Algebra.Curves.BLS12_381.Fr.Std.pow
...
instance FFTField Fr where
  theFFTDomain = ZK.Algebra.Curves.BLS12_381.Fr.Std.fftDomain
...
foreign import ccall unsafe "bls12_381_Fr_std_pow_gen" c_bls12_381_Fr_std_pow_gen :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> CInt -> IO ()
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withInteger expo $ \(nwords,ptr2) -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_pow_gen ptr1 ptr2 ptr3 (fromIntegral nwords)
  return (MkFr fptr3)
...
powBigInt256 (MkFr fptr1) (MkBigInt256 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_pow_gen ptr1 ptr2 ptr3 4
  return (MkFr fptr3)

----------------------------------------

foreign import ccall unsafe "bls12_381_Fr_std_batch_inv" c_bls12_381_Fr_std_batch_inv :: CInt -> Ptr Word64 -> Ptr Word64 -> IO ()
...
batchInv (MkFlatArray n fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_batch_inv (fromIntegral n) ptr1 ptr2
...
foreign import ccall unsafe "bls12_381_Fr_std_neg" c_bls12_381_Fr_std_neg :: Ptr Word64 -> Ptr Word64 -> IO ()
...
neg (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_neg ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_std_add" c_bls12_381_Fr_std_add :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
add (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_add ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_std_sub" c_bls12_381_Fr_std_sub :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sub (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_sub ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_std_sqr" c_bls12_381_Fr_std_sqr :: Ptr Word64 -> Ptr Word64 -> IO ()
...
sqr (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_sqr ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_std_mul" c_bls12_381_Fr_std_mul :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
mul (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_mul ptr1 ptr2 ptr3
  return (MkFr fptr3)

foreign import ccall unsafe "bls12_381_Fr_std_inv" c_bls12_381_Fr_std_inv :: Ptr Word64 -> Ptr Word64 -> IO ()
...
inv (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_inv ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_std_div" c_bls12_381_Fr_std_div :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
div (MkFr fptr1) (MkFr fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_Fr_std_div ptr1 ptr2 ptr3
  return (MkFr fptr3)
...
divBy2 (MkFr fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_div_by_2 ptr1 ptr2
  return (MkFr fptr2)

foreign import ccall unsafe "bls12_381_Fr_std_pow_uint64" c_bls12_381_Fr_std_pow_uint64 :: Ptr Word64 -> Word64 -> Ptr Word64 -> IO ()
...
pow_ (MkFr fptr1) x = unsafePerformIO $ do
  ...
  cret <- withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fr_std_pow_uint64 ptr1 x ptr2
  return (MkFr fptr2)
