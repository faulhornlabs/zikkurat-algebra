...
instance C.Curve G1 where
  ...
  msm             = ZK.Algebra.Curves.BLS12_381.G1.Affine.msm
  curveFFT    = ZK.Algebra.Curves.BLS12_381.G1.Affine.forwardFFT
  curveIFFT   = ZK.Algebra.Curves.BLS12_381.G1.Affine.inverseFFT
...
instance C.AffineCurve G1 where
  ...
  binaryMSM_       = ZK.Algebra.Curves.BLS12_381.G1.Affine.msmBinary
  binaryMultiMSM_  = ZK.Algebra.Curves.BLS12_381.G1.Affine.binaryMultiMSM
