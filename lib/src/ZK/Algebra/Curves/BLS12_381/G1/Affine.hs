...
msm :: L.FlatArray Fr -> L.FlatArray ZK.Algebra.Curves.BLS12_381.G1.Affine.G1 -> G1
msm cs gs = Proj.toAffine $ Proj.msm cs gs

-- | Multi-Scalar Multiplication (MSM), with the coefficients in standard representation
msmStd :: L.FlatArray ZK.Algebra.Curves.BLS12_381.Fr.Std.Fr -> L.FlatArray ZK.Algebra.Curves.BLS12_381.G1.Affine.G1 -> G1
