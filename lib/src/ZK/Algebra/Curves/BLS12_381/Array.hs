...
foreign import ccall unsafe "bls12_381_arr_mont_sparse_matrix_mul"  c_bls12_381_arr_mont_sparse_matrix_mul :: CInt -> CInt -> Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
          ...
          withForeignPtr fptr_cfs $ \ptr_cfs -> do
            withForeignPtr fptr_src $ \ptr_src -> do
              withForeignPtr fptr_out $ \ptr_out -> do
                c_bls12_381_arr_mont_sparse_matrix_mul (fromIntegral n) (fromIntegral k1) ptr_row ptr_col ptr_cfs ptr_src ptr_out
