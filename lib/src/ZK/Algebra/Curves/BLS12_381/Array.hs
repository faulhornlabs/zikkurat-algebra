...
foreign import ccall unsafe "bls12_381_arr_mont_scaled" c_bls12_381_arr_mont_scaled :: CInt -> Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
scale (MkFr fptr1) (MkFlatArray n2 fptr2) =
  unsafePerformIO $ do
    ...
    withForeignPtr fptr1 $ \ptr1 -> do
      withForeignPtr fptr2 $ \ptr2 -> do
         withForeignPtr fptr3 $ \ptr3 -> do
           c_bls12_381_arr_mont_scaled (fromIntegral n2) ptr1 ptr2 ptr3
