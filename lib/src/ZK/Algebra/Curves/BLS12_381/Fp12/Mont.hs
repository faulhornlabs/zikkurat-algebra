...
instance C.Ring Fp12 where
  ringName _ = "BLS12_381/Fp12"
  ringSize _ = C.ringSize (Proxy @Fp6) ^ 2
...
instance C.Field Fp12 where
  characteristics _ = C.characteristics (Proxy @Fp6)
  dimension       _ = C.dimension       (Proxy @Fp6) * 2
...
foreign import ccall unsafe "bls12_381_Fp12_mont_div_by_2" c_bls12_381_Fp12_mont_div_by_2 :: Ptr Word64 -> Ptr Word64 -> IO ()
...
divBy2 (MkFp12 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fp12_mont_div_by_2 ptr1 ptr2
  return (MkFp12 fptr2)
...
foreign import ccall unsafe "bls12_381_Fp12_mont_frobenius" c_bls12_381_Fp12_mont_frobenius :: Ptr Word64 -> Ptr Word64 -> IO ()
...
frob (MkFp12 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fp12_mont_frobenius ptr1 ptr2
  return (MkFp12 fptr2)
