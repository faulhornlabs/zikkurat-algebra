...
foreign import ccall unsafe "bls12_381_Fp_mont_batch_from_std" c_bls12_381_Fp_mont_batch_from_std :: CInt -> Ptr Word64 -> Ptr Word64 -> IO ()
...
batchFromStd (MkFlatArray n fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fp_mont_batch_from_std (fromIntegral n) ptr1 ptr2
  return (MkFlatArray n fptr2)

foreign import ccall unsafe "bls12_381_Fp_mont_batch_to_std" c_bls12_381_Fp_mont_batch_to_std :: CInt -> Ptr Word64 -> Ptr Word64 -> IO ()
...
batchToStd (MkFlatArray n fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bls12_381_Fp_mont_batch_to_std (fromIntegral n) ptr1 ptr2
  return (MkFlatArray n fptr2)
