...
module ZK.Algebra.Curves.BLS12_381.Std.Fr where
...
foreign import ccall unsafe "bls12_381_r_std_pow_gen" c_bls12_381_r_std_pow_gen :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bls12_381_r_std_pow_gen ptr1 ptr2 ptr3
  return (MkFr fptr3)
