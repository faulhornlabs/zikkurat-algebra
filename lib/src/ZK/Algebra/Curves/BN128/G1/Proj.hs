...
foreign import ccall unsafe "bn128_G1_is_on_curve" c_bn128_G1_is_on_curve :: Ptr Word64 -> IO Word8

{-# NOINLINE isOnCurve #-}
isOnCurve :: G1 -> Bool
isOnCurve (MkG1 fptr) = unsafePerformIO $ do
  cret <- withForeignPtr fptr $ \ptr -> do
    c_bn128_G1_is_on_curve ptr
  return (cret /= 0)

foreign import ccall unsafe "bn128_G1_is_infinity" c_bn128_G1_is_infinity :: Ptr Word64 -> IO Word8

{-# NOINLINE isInfinity #-}
isInfinity :: G1 -> Bool
isInfinity (MkG1 fptr) = unsafePerformIO $ do
  cret <- withForeignPtr fptr $ \ptr -> do
    c_bn128_G1_is_infinity ptr
  return (cret /= 0)

foreign import ccall unsafe "bn128_G1_is_equal" c_bn128_G1_is_equal :: Ptr Word64 -> Ptr Word64 -> IO Word8
...
isEqual (MkG1 fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  cret <- withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_is_equal ptr1 ptr2
  return (cret /= 0)

foreign import ccall unsafe "bn128_G1_is_same" c_bn128_G1_is_same :: Ptr Word64 -> Ptr Word64 -> IO Word8
...
isSame (MkG1 fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  cret <- withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_is_same ptr1 ptr2
  return (cret /= 0)

foreign import ccall unsafe "bn128_G1_normalize" c_bn128_G1_normalize :: Ptr Word64 -> Ptr Word64 -> IO ()
...
normalize (MkG1 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_normalize ptr1 ptr2
  return (MkG1 fptr2)

foreign import ccall unsafe "bn128_G1_neg" c_bn128_G1_neg :: Ptr Word64 -> Ptr Word64 -> IO ()
...
neg (MkG1 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_neg ptr1 ptr2
  return (MkG1 fptr2)

foreign import ccall unsafe "bn128_G1_dbl" c_bn128_G1_dbl :: Ptr Word64 -> Ptr Word64 -> IO ()
...
dbl (MkG1 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_dbl ptr1 ptr2
  return (MkG1 fptr2)

foreign import ccall unsafe "bn128_G1_add" c_bn128_G1_add :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
add (MkG1 fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_G1_add ptr1 ptr2 ptr3
  return (MkG1 fptr3)

foreign import ccall unsafe "bn128_G1_sub" c_bn128_G1_sub :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sub (MkG1 fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_G1_sub ptr1 ptr2 ptr3
  return (MkG1 fptr3)

foreign import ccall unsafe "bn128_G1_scl_Fr" c_bn128_G1_scl_Fr :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sclFr (MkFr fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_G1_scl_Fr ptr1 ptr2 ptr3
  return (MkG1 fptr3)

foreign import ccall unsafe "bn128_G1_scl_big" c_bn128_G1_scl_big :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sclBigNonNeg (BigP.MkBigInt256 fptr1) (MkG1 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_G1_scl_big ptr1 ptr2 ptr3
  return (MkG1 fptr3)

foreign import ccall unsafe "bn128_G1_scl_small" c_bn128_G1_scl_small :: CInt -> Ptr Word64 -> Ptr Word64 -> IO ()
...
sclSmallNonNeg k1 (MkG1 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr2 $ \ptr2 -> do
    withForeignPtr fptr3 $ \ptr3 -> do
      c_bn128_G1_scl_small (fromIntegral k1) ptr2 ptr3
  return (MkG1 fptr3)

foreign import ccall unsafe "bn128_G1_scale_by_A" c_bn128_G1_scale_by_A :: Ptr Word64 -> Ptr Word64 -> IO ()
...
scaleByA (MkFp fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_scale_by_A ptr1 ptr2
  return (MkFp fptr2)

foreign import ccall unsafe "bn128_G1_scale_by_B" c_bn128_G1_scale_by_B :: Ptr Word64 -> Ptr Word64 -> IO ()
...
scaleByB (MkFp fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_scale_by_B ptr1 ptr2
  return (MkFp fptr2)

foreign import ccall unsafe "bn128_G1_scale_by_3B" c_bn128_G1_scale_by_3B :: Ptr Word64 -> Ptr Word64 -> IO ()
...
scaleBy3B (MkFp fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_G1_scale_by_3B ptr1 ptr2
  return (MkFp fptr2)
