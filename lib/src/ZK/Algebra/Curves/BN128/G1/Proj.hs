...
instance C.ProjCurve G1 where
  ...
  binaryMSM       = ZK.Algebra.Curves.BN128.G1.Proj.msmBinary
  binaryMultiMSM  = ZK.Algebra.Curves.BN128.G1.Proj.binaryMultiMSM
...
foreign import ccall unsafe "bn128_G1_proj_MSM_binary_coeff_proj_out" c_bn128_G1_proj_MSM_binary_coeff_proj_out :: CInt -> Ptr Word8  -> Ptr Word64 -> Ptr Word64 -> IO ()

foreign import ccall unsafe "bn128_G1_proj_multi_MSM_binary_coeff_proj_out" c_bn128_G1_proj_multi_MSM_binary_coeff_proj_out :: CInt -> CInt -> Ptr (Ptr Word8) -> Ptr Word64 -> Ptr Word64 -> IO ()
foreign import ccall unsafe "bn128_G1_proj_multi_MSM_binary_coeff_affine_out" c_bn128_G1_proj_multi_MSM_binary_coeff_affine_out :: CInt -> CInt -> Ptr (Ptr Word8) -> Ptr Word64 -> Ptr Word64 -> IO ()
...
msmBinary (MkFlatArray n1 fptr1) (MkFlatArray n2 fptr2)
  ...
  | otherwise  = unsafePerformIO $ do
      ...
      withForeignPtr fptr1 $ \ptr1 -> do
        withForeignPtr fptr2 $ \ptr2 -> do
          withForeignPtr fptr3 $ \ptr3 -> do
            c_bn128_G1_proj_MSM_binary_coeff_proj_out (fromIntegral n1) (castPtr ptr1) ptr2 ptr3
      return (MkG1 fptr3)
  ...
  | otherwise  = unsafePerformIO $ do
      ...
      L.withFlatArrays flatarrs $ \list -> do
        ...
        withArray ptrs $ \ptr_ptrs -> do
          withForeignPtr fptr2 $ \ptr2 -> do
            withForeignPtr fptr3 $ \ptr3 -> do
              c_bn128_G1_proj_multi_MSM_binary_coeff_proj_out (fromIntegral narrs) (fromIntegral n1) ptr_ptrs ptr2 ptr3
  ...
  | otherwise  = unsafePerformIO $ do
      ...
      L.withFlatArrays flatarrs $ \list -> do
        ...
        withArray ptrs $ \ptr_ptrs -> do
          withForeignPtr fptr2 $ \ptr2 -> do
            withForeignPtr fptr3 $ \ptr3 -> do
              c_bn128_G1_proj_multi_MSM_binary_coeff_affine_out (fromIntegral narrs) (fromIntegral n1) ptr_ptrs ptr2 ptr3
      return (MkFlatArray narrs fptr3)
  where
    narrs = length flatarrs
    ns    = map L.flatArrayLength flatarrs
