...
foreign import ccall unsafe "bn128_Fp6_mont_from_base_field"  c_bn128_Fp6_mont_from_base_field  :: Ptr Word64 -> Ptr Word64 -> IO ()
foreign import ccall unsafe "bn128_Fp6_mont_from_prime_field" c_bn128_Fp6_mont_from_prime_field :: Ptr Word64 -> Ptr Word64 -> IO ()

foreign import ccall unsafe "bn128_Fp6_mont_scale_by_base_field"  c_bn128_Fp6_mont_scale_by_base_field  :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
foreign import ccall unsafe "bn128_Fp6_mont_scale_by_prime_field" c_bn128_Fp6_mont_scale_by_prime_field :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
...
embedBase (MkFp2 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp6_mont_from_base_field ptr1 ptr2
  return (MkFp6 fptr2)
...
embedPrime (MkFp fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp6_mont_from_prime_field ptr1 ptr2
  return (MkFp6 fptr2)
...
scaleBase (MkFp2 fptr1) (MkFp6 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_Fp6_mont_scale_by_base_field ptr1 ptr2 ptr3
  return (MkFp6 fptr3)
...
scalePrime (MkFp fptr1) (MkFp6 fptr2) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_Fp6_mont_scale_by_prime_field ptr1 ptr2 ptr3
  return (MkFp6 fptr3)
...
foreign import ccall unsafe "bn128_Fp6_mont_div_by_2" c_bn128_Fp6_mont_div_by_2 :: Ptr Word64 -> Ptr Word64 -> IO ()
...
divBy2 (MkFp6 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp6_mont_div_by_2 ptr1 ptr2
  return (MkFp6 fptr2)
...
foreign import ccall unsafe "bn128_Fp6_mont_frobenius" c_bn128_Fp6_mont_frobenius :: Ptr Word64 -> Ptr Word64 -> IO ()
...
frob (MkFp6 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp6_mont_frobenius ptr1 ptr2
  return (MkFp6 fptr2)
