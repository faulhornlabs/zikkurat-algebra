...
module ZK.Algebra.Curves.BN128.Std.Fp where
...
foreign import ccall unsafe "bn128_p_std_pow_gen" c_bn128_p_std_pow_gen :: Ptr Word64 -> Ptr Word64 -> Ptr Word64 -> IO ()
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      withForeignPtr fptr3 $ \ptr3 -> do
        c_bn128_p_std_pow_gen ptr1 ptr2 ptr3
  return (MkFp fptr3)
