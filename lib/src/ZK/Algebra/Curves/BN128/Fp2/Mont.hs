...
foreign import ccall unsafe "bn128_Fp2_mont_div_by_2" c_bn128_Fp2_mont_div_by_2 :: Ptr Word64 -> Ptr Word64 -> IO ()
...
divBy2 (MkFp2 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp2_mont_div_by_2 ptr1 ptr2
  return (MkFp2 fptr2)
...
foreign import ccall unsafe "bn128_Fp2_mont_frobenius" c_bn128_Fp2_mont_frobenius :: Ptr Word64 -> Ptr Word64 -> IO ()
...
frob (MkFp2 fptr1) = unsafePerformIO $ do
  ...
  withForeignPtr fptr1 $ \ptr1 -> do
    withForeignPtr fptr2 $ \ptr2 -> do
      c_bn128_Fp2_mont_frobenius ptr1 ptr2
  return (MkFp2 fptr2)
