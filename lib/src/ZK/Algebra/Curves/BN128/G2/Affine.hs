...
msmStd :: L.FlatArray ZK.Algebra.Curves.BN128.Fr.Std.Fr -> L.FlatArray G2 -> G2
...
instance C.AffineCurve G2 where
  ...
  binaryMSM_       = ZK.Algebra.Curves.BN128.G2.Affine.msmBinary
  binaryMultiMSM_  = ZK.Algebra.Curves.BN128.G2.Affine.binaryMultiMSM
