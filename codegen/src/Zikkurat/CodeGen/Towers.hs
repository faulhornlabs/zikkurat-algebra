...
extParams_bn128_Fp2 = ExtParams 
  ...
  , base_prefix    = "bn128_Fp_mont_"         --  perfix for the C names of base field
  ...
  , c_path_base    = Path ["curves", "fields", "mont", "bn128_Fp_mont" ]            --  C path of the std. repr. version
...
extParams_bn128_Fp6 = ExtParams 
  ...
  , base_prefix    = "bn128_Fp2_mont_"        --  perfix for the C names of base field
  ...
  , hs_path_base   = Path ["ZK","Algebra","Curves","BN128","Fp2","Mont"]             --  the module path of the std. repr. version
  , typeName       = "Fp6"
  , typeNameBase   = "Fp2"
...
extParams_bn128_Fp12 = ExtParams 
  ...
  , base_prefix    = "bn128_Fp6_mont_"        --  perfix for the C names of base field
  , extDegree      = 2                        --  degree of the extension
  ...
  , hs_path_base   = Path ["ZK","Algebra","Curves","BN128","Fp6" ,"Mont"]            --  the module path of the std. repr. version
  , typeName       = "Fp12"
  , typeNameBase   = "Fp6"
...
extParams_bls12_381_Fp2 = ExtParams 
  ...
  , base_prefix    = "bls12_381_Fp_mont_"         --  perfix for the C names of base field
  , extDegree      = 2                            --  degree of the extension
  ...
  , hs_path_base   = Path ["ZK","Algebra","Curves","BLS12_381","Fp" ,"Mont"]            --  the module path of the std. repr. version
  , typeName       = "Fp2"
  , typeNameBase   = "Fp"
...
extParams_bls12_381_Fp6 = ExtParams 
  ...
  , base_prefix    = "bls12_381_Fp2_mont_"        --  perfix for the C names of base field
  , extDegree      = 3                            --  degree of the extension
...
extParams_bls12_381_Fp12 = ExtParams 
  ...
  , base_prefix    = "bls12_381_Fp6_mont_"        --  perfix for the C names of base field
  , extDegree      = 2                            --  degree of the extension
  ...
  , c_path_base    = Path ["curves", "fields", "mont", "bls12_381_Fp6_mont"]             --  C path of the std. repr. version
